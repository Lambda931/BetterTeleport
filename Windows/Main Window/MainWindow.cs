...
public partial class MainWindow : Window, IDisposable
{
    ...
    private void PopulateTable(uint i)
    {
        ...
        {
            BetterTeleport.Log.Info($"{Aetheryte.AetheryteName(i).ToString()} is attuned");
            ...
            {
                BetterTeleport.Log.Error("Teleport Texture is null");
            }
        }
        else
        {
            BetterTeleport.Log.Info($"{Aetheryte.AetheryteName(i).ToString()} is not attuned");
        }
    }
